...
var UsuariosApiService = /** @class */ (function () {
    function UsuariosApiService(_http) {
        this._http = _http;
    }
    UsuariosApiService.prototype.encontrarTodos = function () {
        return this._http
            .get(base + "/usuario")
            .toPromise()
            .then(function (us) {
            return us.map(function (u) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, u, { idade: new Date(String(u.idade)) })); });
        });
    };
    UsuariosApiService.prototype.encontrarPorId = function (id) {
        return this._http
            .get(base + "/usuario/" + id)
            .toPromise()
            .then(function (response) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, response, { idade: new Date(String(response.idade)) })); });
    };
    UsuariosApiService.prototype.cadastrar = function (usuario) {
        var toBePersistedUsuario = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, usuario, { ativo: 1 });
        return this._http.post(base + "/usuario", toBePersistedUsuario).toPromise();
    };
    UsuariosApiService.prototype.atualizar = function (id, usuario) {
        return this._http
            .put(base + "/usuario/" + id, usuario)
            .toPromise()
            .then(function () { return usuario; });
    };
    UsuariosApiService.prototype.apagar = function (id) {
        return this._http.delete(base + "/usuario/" + id).toPromise();
    };
    UsuariosApiService.ctorParameters = function () { return [
...
var snackBarTime = 5000;
var UsuariosCreateComponent = /** @class */ (function () {
    function UsuariosCreateComponent(_usuariosApi, _router, _snackBar) {
        this._usuariosApi = _usuariosApi;
        this._router = _router;
        this._snackBar = _snackBar;
    }
    UsuariosCreateComponent.prototype.salvar = function (usuario) {
        var _this = this;
        this._usuariosApi
            .cadastrar(usuario)
            .then(function () { return _this._router.navigate(['/', 'usuarios']); })
            .then(function () { return _this._snackBar.open('Usuário cadastrado com sucesso', undefined, { duration: snackBarTime }); })
            .catch(function (e) { return _this._snackBar.open("Erro ao cadastrar: " + e.error, undefined, { duration: snackBarTime }); });
    };
    UsuariosCreateComponent.ctorParameters = function () { return [
...
var UsuariosEditComponent = /** @class */ (function () {
    function UsuariosEditComponent(_activatedRoute, _usuariosApiService, _snackBar, _router) {
    ...
    UsuariosEditComponent.prototype.ngOnInit = function () {
        ...
        this._usuariosApiService.encontrarPorId(this.id).then(function (usuario) {
            _this.usuario = usuario;
        });
    };
    UsuariosEditComponent.prototype.editar = function (usuario) {
        var _this = this;
        this._usuariosApiService
            .atualizar(this.id, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.usuario, usuario))
            .then(function () { return _this._router.navigate(['/usuarios']); })
            .then(function () { return _this._snackBar.open('Usuário atualizado com sucesso', undefined, { duration: duration }); })
            .catch(function (e) { return (console.error(e), _this._snackBar.open("Erro ao atualizar usu\u00E1rio: " + e.error)); });
    };
    UsuariosEditComponent.ctorParameters = function () { return [
...
var UsuariosFormComponent = /** @class */ (function () {
    function UsuariosFormComponent(_formBuilder) {
    ...
    UsuariosFormComponent.prototype.submitForm = function () {
        this.conclude.emit(this.formGroup.value);
    };
    UsuariosFormComponent.prototype._buildFormGroup = function () {
        return this._formBuilder.group({
            nome: [],
            idade: [],
        });
    };
    UsuariosFormComponent.ctorParameters = function () { return [
...
var UsuariosListingComponent = /** @class */ (function () {
    function UsuariosListingComponent(_usuarioApiService, _router) {
        this._usuarioApiService = _usuarioApiService;
        this._router = _router;
        this.usuarios = [];
    }
    UsuariosListingComponent.prototype.ngOnInit = function () {
        this._loadListing();
    };
    UsuariosListingComponent.prototype.apagar = function (id) {
        var _this = this;
        this._usuarioApiService.apagar(id).then(function () { return _this._loadListing(); });
    };
    UsuariosListingComponent.prototype.editar = function (id) {
        this._router.navigate(['/usuarios/edit', id]);
    };
    UsuariosListingComponent.prototype._loadListing = function () {
        var _this = this;
        this._usuarioApiService.encontrarTodos().then(function (todos) {
            _this.usuarios = todos;
        });
    };
    UsuariosListingComponent.ctorParameters = function () { return [
        { type: _usuarios_api_service__WEBPACK_IMPORTED_MODULE_2__["UsuariosApiService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
    ...
    return UsuariosListingComponent;
}());
